    ...
    if (isPosting) {
      return (
        <div className='newPost'>
          ...
          <div className='newPost-postRow'>
            <div className='topic'>
              #
              <input type='text' placeholder='topic' className='topicInput' value={topicValue} disabled={true} />
            </div>
            <div>
      ...
      return (
        <div className='newPost'>
          ...
          />
          <div className='newPost-postRow'>
            <div className='topic' style={{ color: topicValue && 'rgb( 80, 162, 255)' }}>
              #
              <input
                type='text'
                placeholder='topic'
            ...
            <div>
              <button className='submitButton' disabled={isDisabled} onClick={onPostButtonClicked}>
                Post
              </button>
            </div>
          </div>
